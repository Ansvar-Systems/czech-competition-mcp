...
const TOOLS = [
    {
        ...
        description: "Full-text search across Bundeskartellamt enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and UOHS articles cited.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Get a specific Bundeskartellamt decision by case number (e.g., 'B6-22/16').",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Search Bundeskartellamt merger control decisions (merger control).",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Get a specific merger control decision by case number (e.g., 'B1-35/21').",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "List all sectors with Bundeskartellamt enforcement activity, including decision and merger counts.",
            ...
            switch (name) {
                ...
                case "cz_comp_about": {
                    return textContent({
                        name: SERVER_NAME,
                        version: pkgVersion,
                        description: "Bundeskartellamt (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the UOHS (Gesetz gegen Wettbewerbsbeschränkungen).",
