...
const TOOLS = [
    {
        ...
        description: "Full-text search across UOHS competition enforcement decisions. Covers abuse of dominance, cartel enforcement, public procurement violations, and sector inquiries under Czech competition law (ZOHS). Returns matching decisions with case number, parties, sector, outcome, and summary.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "Get a specific UOHS competition decision by case number (e.g., 'UOHS-S0001/2024/KD', 'UOHS-R0050/2023/HS').",
        inputSchema: {
            type: "object",
            properties: {
                case_number: {
    ...
    },
    {
        ...
        description: "Search UOHS merger control decisions. Returns merger cases with acquiring party, target, sector, turnover thresholds, and clearance outcome.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "Get a specific UOHS merger control decision by case number (e.g., 'UOHS-S0010/2024/KS').",
        inputSchema: {
            type: "object",
            properties: {
                case_number: {
    ...
    },
    {
        ...
        description: "List all industry sectors with UOHS enforcement activity covered in this MCP, with decision and merger counts.",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
        ...
        switch (name) {
            ...
            case "cz_comp_about": {
                return textContent({
                    name: SERVER_NAME,
                    version: pkgVersion,
                    description: "UOHS (Úřad pro ochranu hospodářské soutěže — Czech Office for the Protection of Competition) MCP server. Provides access to competition enforcement decisions, merger control cases, public procurement oversight, and sector inquiries under Czech competition law (ZOHS).",
